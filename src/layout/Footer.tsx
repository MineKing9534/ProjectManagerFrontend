	...
	return (
		<footer className="w-full h-[35px] select-none">
			...
			<div className="z-40 flex px-6 gap-4 w-full flex-row relative flex-nowrap whitespace-nowrap items-center justify-between h-full max-w-full">
				...
				<span className="justify-end hidden md:block"><Link showAnchorIcon className="text-foreground" target="_blank" href={ `https://github.com/${ import.meta.env._REPOSITORY }` }>{ import.meta.env._REPOSITORY }</Link></span>
			</div>
		</footer>
	)
}